  ...
  switch (name) {
    case "dashboard":
      return (
        ...
        >
          <path
            d="M3 13h8V3H3v10zM13 21h8V11h-8v10zM13 3v6h8"
            strokeWidth="1.5"
            strokeLinecap="round"
    ...
    case "jogadores":
      return (
        ...
        >
          <path
            d="M16 11c1.657 0 3-1.343 3-3s-1.343-3-3-3-3 1.343-3 3 1.343 3 3 3zM8 11c1.657 0 3-1.343 3-3S9.657 5 8 5 5 6.343 5 8s1.343 3 3 3zM2 21c0-3 4-5 6-5s6 2 6 5"
            strokeWidth="1.5"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
    ...
    case "campeonatos":
      return (
        ...
        >
          <path
            d="M8 2h8l1 5H7l1-5zM5 9h14l-1 7a6 6 0 01-6 4 6 6 0 01-6-4L5 9z"
            strokeWidth="1.2"
            strokeLinecap="round"
            strokeLinejoin="round"
          />
